  ...
  return (
    <nav className="absolute top-0 left-0 w-full lg:pt-10 lg:pl-10 md:pl-6 flex flex-row justify-between items-center z-10">
      ...
      <div className="md:hidden flex justify-between items-center w-full p-4 mt-4">
        ...
        {isOpen && (
          <nav className="md:hidden flex flex-col bg-black text-white fixed top-0 right-0 h-full w-[70%] pt-10 z-20 transition ease-in-out duration-300 items-center bg-opacity-50 backdrop-blur-xl shadow-md font-barlow">
