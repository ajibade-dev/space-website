 ...
 const toggleMenu = () => {
  ...
  return (
    <nav className="absolute top-0 left-0 w-full lg:pt-10 lg:pl-10 md:pl-6 flex flex-row justify-between items-center z-10">
      ...
      <ul className="md:flex hidden space-x-6 text-white h-[96px] items-center justify-items-end px-16 gap-12 
       ...
       {/* for the mobile menu */}
       <div className='md:hidden flex justify-between items-center w-full p-10 mt-4'>
      ...
      {isOpen && (
            <nav className="md:hidden flex flex-col bg-white text-white fixed top-0 right-0 h-full w-[70%] pt-10  z-20 transition ease-in-out duration-300 items-center bg-opacity-10 backdrop-blur-md shadow-md font-barlow">
